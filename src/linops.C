...
//Ctor
ANought::ANought(Input & input_obj__,
                 Spectral & spectral_obj__,
                 Basic & basic__):
...
//ANought(w_hat)
CBVF ANought::operator()(const CBVF & w_hat)
// const
{
...
//Ctor
ANoughtAdjoint::ANoughtAdjoint(Input & input_obj__,
                               Spectral & spectral_obj__,
                               Basic & basic__):
    linops_base(input_obj__,spectral_obj__,basic__)
{}
...
//Dtor
ANoughtAdjoint::~ANoughtAdjoint()
{}

//ANoughtAdjoint(w_hat)
CBVF ANoughtAdjoint::operator()(const CBVF & w_hat)
//const
{
...
//AOne(index)
CBVF AOne::operator()(const CBVF & field,const int & index)
// const
{
